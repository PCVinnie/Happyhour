    ...
    public sealed partial class NewPub : Page
    {
        ...
        public void inputData()
        {
            ...
            else
            {
                ...
                LocationData pub = new LocationData(name, street, houseNumber, zipCode, city, country, selectedRatingIndex, openTimes, closeTimes, Convert.ToDouble(longitude), Convert.ToDouble(latitude), happyhourFrom, happyhourTo);
