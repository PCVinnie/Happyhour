    ...
    public sealed partial class ChangePub : Page
    {
        ...
        public void inputData()
        {
            ...
            if (string.IsNullOrEmpty(name))
                ...
                LocationData p = new LocationData(name, street, houseNumber, zipCode, city, country, selectedRatingIndex, openTimes, closeTimes, Convert.ToDouble(longitude), Convert.ToDouble(latitude), happyhourFrom, happyhourTo);
                p.id = pub.id;
